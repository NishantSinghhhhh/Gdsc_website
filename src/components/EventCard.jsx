...
const EventCard = () => {
  return (
    <div className="border  rounded-3xl w-full max-w-md mx-auto md:max-w-2xl lg:max-w-3xl border-black flex  shadow-lg p-4">
      <div className="flex flex-col gap-4 items-center justify-center rounded-3xl w-full md:w-2/5 mb-4 md:mb-0">
        ...
        <div className="rounded-full w-[100%] h-[40px] max-w-xs bg-white flex items-center justify-between p-2 border border-black">
          ...
          <div className="-mr-[1rem] w-[2.7rem] h-[2.5rem] rounded-full overflow-hidden transform transition-transform duration-300 hover:-rotate-45">
